...
export const SettingsModal = ({ initialApiKey, initialModel, initialTone, onSave, onClose }) => {
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 animate-fade-in">
            <div className="bg-gray-800 rounded-lg p-6 w-full max-w-md animate-scale-in">
                    ...
                    <div>
                        ...
                        <div className="flex items-center">
                            <input 
                                ...
                                className="w-full bg-gray-700 border border-gray-600 rounded-md px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
                            />
                        </div>
                    </div>
                ...
                <div className="flex justify-end gap-2 mt-6">
                    ...
                    <button onClick={handleSave} className="px-4 py-2 bg-pink-600 hover:bg-pink-700 rounded-md text-sm font-bold flex items-center gap-2">
